  ...
  return (
    <main className="flex flex-col bg-white">
      ...
      <section 
          ...
          style={{ backgroundImage: `url(${jobScoutImg})`, backgroundSize: '100%', backgroundPosition: 'bottom center', backgroundRepeat: 'no-repeat', paddingBottom: '20%'}}
        >
     ...
     {/* our most popular component */} 
      ...
      <div
        className={
          isColumn ? 'flex flex-col space-y-4' : 'flex justify-between items-stretch space-x-4 overflow-x-auto'
        }>
